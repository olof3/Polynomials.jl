...
@test sprint(show, Poly([-1+1im])) == ("Poly(-(1 - 1im))")
@test sprint(show, Poly([1-1im])) == ("Poly((1 - 1im))")
@test sprint(show, Poly([-1im])) == ("Poly(-(1im))")
@test sprint(show, Poly([1, 1im])) == ("Poly(1 + (1im)x)")
@test sprint(show, Poly([-1, 1im])) == ("Poly(-1 + (1im)x)")
@test sprint(show, Poly([-1, 2])) == ("Poly(-1 + 2x)")
@test sprint(show, Poly([-1im, 2])) == ("Poly(-(1im) + 2x)")
